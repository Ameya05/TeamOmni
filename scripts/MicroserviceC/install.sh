...
sudo docker build --build-arg APP_URL=https://s3-us-west-2.amazonaws.com/sga-team-omni/omniStormDetector.tar.gz -e JETTY_VERSION 9.3.14.v20161028 -t omni/stormdetect:v1 . >> /var/log/sga-docker.log 2>&1
