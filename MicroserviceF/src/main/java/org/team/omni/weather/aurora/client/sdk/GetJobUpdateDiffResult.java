...
public class GetJobUpdateDiffResult implements org.apache.thrift.TBase<GetJobUpdateDiffResult, GetJobUpdateDiffResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetJobUpdateDiffResult> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.add = new HashSet<ConfigGroup>(2*_set350.size);
                ConfigGroup _elem351;
                for (int _i352 = 0; _i352 < _set350.size; ++_i352)
                {
                  _elem351 = new ConfigGroup();
                  _elem351.read(iprot);
                  struct.add.add(_elem351);
                }
                iprot.readSetEnd();
              }
          ...
          case 2: // REMOVE
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set353 = iprot.readSetBegin();
                struct.remove = new HashSet<ConfigGroup>(2*_set353.size);
                ConfigGroup _elem354;
                for (int _i355 = 0; _i355 < _set353.size; ++_i355)
                {
                  _elem354 = new ConfigGroup();
                  _elem354.read(iprot);
                  struct.remove.add(_elem354);
                }
                iprot.readSetEnd();
              }
          ...
          case 3: // UPDATE
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set356 = iprot.readSetBegin();
                struct.update = new HashSet<ConfigGroup>(2*_set356.size);
                ConfigGroup _elem357;
                for (int _i358 = 0; _i358 < _set356.size; ++_i358)
                {
                  _elem357 = new ConfigGroup();
                  _elem357.read(iprot);
                  struct.update.add(_elem357);
                }
                iprot.readSetEnd();
              }
          ...
          case 4: // UNCHANGED
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set359 = iprot.readSetBegin();
                struct.unchanged = new HashSet<ConfigGroup>(2*_set359.size);
                ConfigGroup _elem360;
                for (int _i361 = 0; _i361 < _set359.size; ++_i361)
                {
                  _elem360 = new ConfigGroup();
                  _elem360.read(iprot);
                  struct.unchanged.add(_elem360);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetJobUpdateDiffResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.add != null) {
        oprot.writeFieldBegin(ADD_FIELD_DESC);
        {
          ...
          for (ConfigGroup _iter362 : struct.add)
          {
      ...
      if (struct.remove != null) {
        oprot.writeFieldBegin(REMOVE_FIELD_DESC);
        {
          ...
          for (ConfigGroup _iter363 : struct.remove)
          {
      ...
      if (struct.update != null) {
        oprot.writeFieldBegin(UPDATE_FIELD_DESC);
        {
          ...
          for (ConfigGroup _iter364 : struct.update)
          {
      ...
      if (struct.unchanged != null) {
        oprot.writeFieldBegin(UNCHANGED_FIELD_DESC);
        {
          ...
          for (ConfigGroup _iter365 : struct.unchanged)
          {
  ...
  private static class GetJobUpdateDiffResultTupleScheme extends TupleScheme<GetJobUpdateDiffResult> {
      ...
      if (struct.isSetAdd()) {
        {
          ...
          for (ConfigGroup _iter366 : struct.add)
          {
      ...
      if (struct.isSetRemove()) {
        {
          ...
          for (ConfigGroup _iter367 : struct.remove)
          {
      ...
      if (struct.isSetUpdate()) {
        {
          ...
          for (ConfigGroup _iter368 : struct.update)
          {
      ...
      if (struct.isSetUnchanged()) {
        {
          ...
          for (ConfigGroup _iter369 : struct.unchanged)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetJobUpdateDiffResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set370 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.add = new HashSet<ConfigGroup>(2*_set370.size);
          ConfigGroup _elem371;
          for (int _i372 = 0; _i372 < _set370.size; ++_i372)
          {
            _elem371 = new ConfigGroup();
            _elem371.read(iprot);
            struct.add.add(_elem371);
          }
        }
        struct.setAddIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TSet _set373 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.remove = new HashSet<ConfigGroup>(2*_set373.size);
          ConfigGroup _elem374;
          for (int _i375 = 0; _i375 < _set373.size; ++_i375)
          {
            _elem374 = new ConfigGroup();
            _elem374.read(iprot);
            struct.remove.add(_elem374);
          }
        }
        struct.setRemoveIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TSet _set376 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.update = new HashSet<ConfigGroup>(2*_set376.size);
          ConfigGroup _elem377;
          for (int _i378 = 0; _i378 < _set376.size; ++_i378)
          {
            _elem377 = new ConfigGroup();
            _elem377.read(iprot);
            struct.update.add(_elem377);
          }
        }
        struct.setUpdateIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TSet _set379 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.unchanged = new HashSet<ConfigGroup>(2*_set379.size);
          ConfigGroup _elem380;
          for (int _i381 = 0; _i381 < _set379.size; ++_i381)
          {
            _elem380 = new ConfigGroup();
            _elem380.read(iprot);
            struct.unchanged.add(_elem380);
          }
        }
        struct.setUnchangedIsSet(true);
      }
