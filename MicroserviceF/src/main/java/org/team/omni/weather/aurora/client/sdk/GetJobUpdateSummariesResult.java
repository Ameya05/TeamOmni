            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updateSummaries = new ArrayList<JobUpdateSummary>(_list334.size);
                JobUpdateSummary _elem335;
                for (int _i336 = 0; _i336 < _list334.size; ++_i336)
                {
                  _elem335 = new JobUpdateSummary();
                  _elem335.read(iprot);
                  struct.updateSummaries.add(_elem335);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetJobUpdateSummariesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateSummaries != null) {
        oprot.writeFieldBegin(UPDATE_SUMMARIES_FIELD_DESC);
        {
          ...
          for (JobUpdateSummary _iter337 : struct.updateSummaries)
          {
      ...
      if (struct.isSetUpdateSummaries()) {
        {
          ...
          for (JobUpdateSummary _iter338 : struct.updateSummaries)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.updateSummaries = new ArrayList<JobUpdateSummary>(_list339.size);
          JobUpdateSummary _elem340;
          for (int _i341 = 0; _i341 < _list339.size; ++_i341)
          {
            _elem340 = new JobUpdateSummary();
            _elem340.read(iprot);
            struct.updateSummaries.add(_elem340);
          }
        }
        struct.setUpdateSummariesIsSet(true);
      }
