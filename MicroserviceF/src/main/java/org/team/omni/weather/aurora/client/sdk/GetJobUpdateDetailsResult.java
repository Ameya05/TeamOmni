            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.detailsList = new ArrayList<JobUpdateDetails>(_list342.size);
                JobUpdateDetails _elem343;
                for (int _i344 = 0; _i344 < _list342.size; ++_i344)
                {
                  _elem343 = new JobUpdateDetails();
                  _elem343.read(iprot);
                  struct.detailsList.add(_elem343);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetJobUpdateDetailsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.detailsList != null) {
        oprot.writeFieldBegin(DETAILS_LIST_FIELD_DESC);
        {
          ...
          for (JobUpdateDetails _iter345 : struct.detailsList)
          {
      ...
      if (struct.isSetDetailsList()) {
        {
          ...
          for (JobUpdateDetails _iter346 : struct.detailsList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.detailsList = new ArrayList<JobUpdateDetails>(_list347.size);
          JobUpdateDetails _elem348;
          for (int _i349 = 0; _i349 < _list347.size; ++_i349)
          {
            _elem348 = new JobUpdateDetails();
            _elem348.read(iprot);
            struct.detailsList.add(_elem348);
          }
        }
        struct.setDetailsListIsSet(true);
      }
