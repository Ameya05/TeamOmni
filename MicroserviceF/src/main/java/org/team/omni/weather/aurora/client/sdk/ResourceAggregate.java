            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.resources = new HashSet<Resource>(2*_set92.size);
                Resource _elem93;
                for (int _i94 = 0; _i94 < _set92.size; ++_i94)
                {
                  _elem93 = new Resource();
                  _elem93.read(iprot);
                  struct.resources.add(_elem93);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResourceAggregate struct) throws org.apache.thrift.TException {
      ...
      if (struct.resources != null) {
        oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
        {
          ...
          for (Resource _iter95 : struct.resources)
          {
            _iter95.write(oprot);
          }
          oprot.writeSetEnd();
      ...
      if (struct.isSetResources()) {
        {
          ...
          for (Resource _iter96 : struct.resources)
          {
            _iter96.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.resources = new HashSet<Resource>(2*_set97.size);
          Resource _elem98;
          for (int _i99 = 0; _i99 < _set97.size; ++_i99)
          {
            _elem98 = new Resource();
            _elem98.read(iprot);
            struct.resources.add(_elem98);
          }
        }
        struct.setResourcesIsSet(true);
      }
