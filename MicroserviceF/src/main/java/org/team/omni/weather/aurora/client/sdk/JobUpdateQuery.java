            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                {
                  _elem255 = org.team.omni.weather.aurora.client.sdk.JobUpdateStatus.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobUpdateQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateStatuses != null) {
        oprot.writeFieldBegin(UPDATE_STATUSES_FIELD_DESC);
        {
          ...
          for (JobUpdateStatus _iter257 : struct.updateStatuses)
          {
      ...
      if (struct.isSetUpdateStatuses()) {
        {
          ...
          for (JobUpdateStatus _iter258 : struct.updateStatuses)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          {
            _elem260 = org.team.omni.weather.aurora.client.sdk.JobUpdateStatus.findByValue(iprot.readI32());
