...
public class TaskConfig implements org.apache.thrift.TBase<TaskConfig, TaskConfig._Fields>, java.io.Serializable, Cloneable, Comparable<TaskConfig> {
  ...
  public TaskConfig() {
    ...
    MesosContainer tmp40 = new MesosContainer();

    this.container.setMesos(tmp40);
  ...
  public void clear() {
    ...
    this.metadata = null;
    this.container = new Container();
    MesosContainer tmp41 = new MesosContainer();

    this.container.setMesos(tmp41);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.resources = new HashSet<Resource>(2*_set42.size);
                Resource _elem43;
                for (int _i44 = 0; _i44 < _set42.size; ++_i44)
                {
                  _elem43 = new Resource();
                  _elem43.read(iprot);
                  struct.resources.add(_elem43);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.constraints = new HashSet<Constraint>(2*_set45.size);
                Constraint _elem46;
                for (int _i47 = 0; _i47 < _set45.size; ++_i47)
                {
                  _elem46 = new Constraint();
                  _elem46.read(iprot);
                  struct.constraints.add(_elem46);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.requestedPorts = new HashSet<String>(2*_set48.size);
                String _elem49;
                for (int _i50 = 0; _i50 < _set48.size; ++_i50)
                {
                  _elem49 = iprot.readString();
                  struct.requestedPorts.add(_elem49);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.mesosFetcherUris = new HashSet<MesosFetcherURI>(2*_set51.size);
                MesosFetcherURI _elem52;
                for (int _i53 = 0; _i53 < _set51.size; ++_i53)
                {
                  _elem52 = new MesosFetcherURI();
                  _elem52.read(iprot);
                  struct.mesosFetcherUris.add(_elem52);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.taskLinks = new HashMap<String,String>(2*_map54.size);
                String _key55;
                String _val56;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.metadata = new HashSet<Metadata>(2*_set58.size);
                Metadata _elem59;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.constraints != null) {
        oprot.writeFieldBegin(CONSTRAINTS_FIELD_DESC);
        {
          ...
          for (Constraint _iter61 : struct.constraints)
          {
            _iter61.write(oprot);
          }
          oprot.writeSetEnd();
      ...
      if (struct.requestedPorts != null) {
        oprot.writeFieldBegin(REQUESTED_PORTS_FIELD_DESC);
        {
          ...
          for (String _iter62 : struct.requestedPorts)
          {
      ...
      if (struct.resources != null) {
        oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
        {
          ...
          for (Resource _iter65 : struct.resources)
          {
            _iter65.write(oprot);
          }
          oprot.writeSetEnd();
      ...
      if (struct.mesosFetcherUris != null) {
        if (struct.isSetMesosFetcherUris()) {
          oprot.writeFieldBegin(MESOS_FETCHER_URIS_FIELD_DESC);
          {
            ...
            for (MesosFetcherURI _iter66 : struct.mesosFetcherUris)
            {
              _iter66.write(oprot);
            }
            oprot.writeSetEnd();
  ...
  private static class TaskConfigTupleScheme extends TupleScheme<TaskConfig> {
      ...
      if (struct.isSetResources()) {
        {
          ...
          for (Resource _iter67 : struct.resources)
          {
            _iter67.write(oprot);
          }
        }
      ...
      if (struct.isSetConstraints()) {
        {
          ...
          for (Constraint _iter68 : struct.constraints)
          {
            _iter68.write(oprot);
          }
        }
      ...
      if (struct.isSetRequestedPorts()) {
        {
          ...
          for (String _iter69 : struct.requestedPorts)
          {
      ...
      if (struct.isSetMesosFetcherUris()) {
        {
          ...
          for (MesosFetcherURI _iter70 : struct.mesosFetcherUris)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (struct.isSetTaskLinks()) {
        {
          ...
          for (Map.Entry<String, String> _iter71 : struct.taskLinks.entrySet())
          {
      ...
      if (struct.isSetMetadata()) {
        {
          ...
          for (Metadata _iter72 : struct.metadata)
          {
            _iter72.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TaskConfig struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TSet _set73 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.resources = new HashSet<Resource>(2*_set73.size);
          Resource _elem74;
          for (int _i75 = 0; _i75 < _set73.size; ++_i75)
          {
            _elem74 = new Resource();
            _elem74.read(iprot);
            struct.resources.add(_elem74);
          }
        }
        struct.setResourcesIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TSet _set76 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.constraints = new HashSet<Constraint>(2*_set76.size);
          Constraint _elem77;
          for (int _i78 = 0; _i78 < _set76.size; ++_i78)
          {
            _elem77 = new Constraint();
            _elem77.read(iprot);
            struct.constraints.add(_elem77);
          }
        }
        struct.setConstraintsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.requestedPorts = new HashSet<String>(2*_set79.size);
          String _elem80;
          for (int _i81 = 0; _i81 < _set79.size; ++_i81)
          {
            _elem80 = iprot.readString();
            struct.requestedPorts.add(_elem80);
          }
        }
        struct.setRequestedPortsIsSet(true);
      }
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TSet _set82 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.mesosFetcherUris = new HashSet<MesosFetcherURI>(2*_set82.size);
          MesosFetcherURI _elem83;
          for (int _i84 = 0; _i84 < _set82.size; ++_i84)
          {
            _elem83 = new MesosFetcherURI();
            _elem83.read(iprot);
            struct.mesosFetcherUris.add(_elem83);
          }
        }
        struct.setMesosFetcherUrisIsSet(true);
      }
      if (incoming.get(14)) {
        {
          ...
          struct.taskLinks = new HashMap<String,String>(2*_map85.size);
          String _key86;
          String _val87;
          for (int _i88 = 0; _i88 < _map85.size; ++_i88)
          {
            ...
            struct.taskLinks.put(_key86, _val87);
          }
        }
        struct.setTaskLinksIsSet(true);
      }
      ...
      if (incoming.get(17)) {
        {
          ...
          struct.metadata = new HashSet<Metadata>(2*_set89.size);
          Metadata _elem90;
          for (int _i91 = 0; _i91 < _set89.size; ++_i91)
          {
            _elem90 = new Metadata();
            _elem90.read(iprot);
            struct.metadata.add(_elem90);
          }
        }
        struct.setMetadataIsSet(true);
      }
