        ...
        switch (schemeField.id) {
          ...
          case 2: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status = org.team.omni.weather.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taskEvents = new ArrayList<TaskEvent>(_list126.size);
                TaskEvent _elem127;
                for (int _i128 = 0; _i128 < _list126.size; ++_i128)
                {
                  _elem127 = new TaskEvent();
                  _elem127.read(iprot);
                  struct.taskEvents.add(_elem127);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScheduledTask struct) throws org.apache.thrift.TException {
      ...
      if (struct.taskEvents != null) {
        oprot.writeFieldBegin(TASK_EVENTS_FIELD_DESC);
        {
          ...
          for (TaskEvent _iter129 : struct.taskEvents)
          {
      ...
      if (struct.isSetTaskEvents()) {
        {
          ...
          for (TaskEvent _iter130 : struct.taskEvents)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.taskEvents = new ArrayList<TaskEvent>(_list131.size);
          TaskEvent _elem132;
          for (int _i133 = 0; _i133 < _list131.size; ++_i133)
          {
            _elem132 = new TaskEvent();
            _elem132.read(iprot);
            struct.taskEvents.add(_elem132);
          }
        }
        struct.setTaskEventsIsSet(true);
      }
