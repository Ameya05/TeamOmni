...
public class TaskQuery implements org.apache.thrift.TBase<TaskQuery, TaskQuery._Fields>, java.io.Serializable, Cloneable, Comparable<TaskQuery> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.taskIds = new HashSet<String>(2*_set150.size);
                String _elem151;
                for (int _i152 = 0; _i152 < _set150.size; ++_i152)
                {
                  _elem151 = iprot.readString();
                  struct.taskIds.add(_elem151);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                {
                  _elem154 = org.team.omni.weather.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.instanceIds = new HashSet<Integer>(2*_set156.size);
                int _elem157;
                for (int _i158 = 0; _i158 < _set156.size; ++_i158)
                {
                  _elem157 = iprot.readI32();
                  struct.instanceIds.add(_elem157);
                }
                iprot.readSetEnd();
              }
          ...
          case 10: // SLAVE_HOSTS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set159 = iprot.readSetBegin();
                struct.slaveHosts = new HashSet<String>(2*_set159.size);
                String _elem160;
                for (int _i161 = 0; _i161 < _set159.size; ++_i161)
                {
                  _elem160 = iprot.readString();
                  struct.slaveHosts.add(_elem160);
                }
                iprot.readSetEnd();
              }
          ...
          case 11: // JOB_KEYS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set162 = iprot.readSetBegin();
                struct.jobKeys = new HashSet<JobKey>(2*_set162.size);
                JobKey _elem163;
                for (int _i164 = 0; _i164 < _set162.size; ++_i164)
                {
                  _elem163 = new JobKey();
                  _elem163.read(iprot);
                  struct.jobKeys.add(_elem163);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.taskIds != null) {
        oprot.writeFieldBegin(TASK_IDS_FIELD_DESC);
        {
          ...
          for (String _iter165 : struct.taskIds)
          {
      ...
      if (struct.statuses != null) {
        oprot.writeFieldBegin(STATUSES_FIELD_DESC);
        {
          ...
          for (ScheduleStatus _iter166 : struct.statuses)
          {
      ...
      if (struct.instanceIds != null) {
        oprot.writeFieldBegin(INSTANCE_IDS_FIELD_DESC);
        {
          ...
          for (int _iter167 : struct.instanceIds)
          {
      ...
      if (struct.slaveHosts != null) {
        oprot.writeFieldBegin(SLAVE_HOSTS_FIELD_DESC);
        {
          ...
          for (String _iter168 : struct.slaveHosts)
          {
      ...
      if (struct.jobKeys != null) {
        oprot.writeFieldBegin(JOB_KEYS_FIELD_DESC);
        {
          ...
          for (JobKey _iter169 : struct.jobKeys)
          {
  ...
  private static class TaskQueryTupleScheme extends TupleScheme<TaskQuery> {
      ...
      if (struct.isSetTaskIds()) {
        {
          ...
          for (String _iter170 : struct.taskIds)
          {
      ...
      if (struct.isSetStatuses()) {
        {
          ...
          for (ScheduleStatus _iter171 : struct.statuses)
          {
      ...
      if (struct.isSetInstanceIds()) {
        {
          ...
          for (int _iter172 : struct.instanceIds)
          {
      ...
      if (struct.isSetSlaveHosts()) {
        {
          ...
          for (String _iter173 : struct.slaveHosts)
          {
      ...
      if (struct.isSetJobKeys()) {
        {
          ...
          for (JobKey _iter174 : struct.jobKeys)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TaskQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.taskIds = new HashSet<String>(2*_set175.size);
          String _elem176;
          for (int _i177 = 0; _i177 < _set175.size; ++_i177)
          {
            _elem176 = iprot.readString();
            struct.taskIds.add(_elem176);
          }
        }
        struct.setTaskIdsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TSet _set178 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.statuses = new HashSet<ScheduleStatus>(2*_set178.size);
          ScheduleStatus _elem179;
          for (int _i180 = 0; _i180 < _set178.size; ++_i180)
          {
            _elem179 = org.team.omni.weather.aurora.client.sdk.ScheduleStatus.findByValue(iprot.readI32());
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TSet _set181 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.instanceIds = new HashSet<Integer>(2*_set181.size);
          int _elem182;
          for (int _i183 = 0; _i183 < _set181.size; ++_i183)
          {
            _elem182 = iprot.readI32();
            struct.instanceIds.add(_elem182);
          }
        }
        struct.setInstanceIdsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TSet _set184 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.slaveHosts = new HashSet<String>(2*_set184.size);
          String _elem185;
          for (int _i186 = 0; _i186 < _set184.size; ++_i186)
          {
            _elem185 = iprot.readString();
            struct.slaveHosts.add(_elem185);
          }
        }
        struct.setSlaveHostsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TSet _set187 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.jobKeys = new HashSet<JobKey>(2*_set187.size);
          JobKey _elem188;
          for (int _i189 = 0; _i189 < _set187.size; ++_i189)
          {
            _elem188 = new JobKey();
            _elem188.read(iprot);
            struct.jobKeys.add(_elem188);
          }
        }
        struct.setJobKeysIsSet(true);
      }
