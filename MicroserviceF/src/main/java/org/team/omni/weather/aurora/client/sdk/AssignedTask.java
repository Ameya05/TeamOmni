            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignedPorts = new HashMap<String,Integer>(2*_map116.size);
                String _key117;
                int _val118;
                for (int _i119 = 0; _i119 < _map116.size; ++_i119)
                {
                  ...
                  struct.assignedPorts.put(_key117, _val118);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AssignedTask struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignedPorts != null) {
        oprot.writeFieldBegin(ASSIGNED_PORTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter120 : struct.assignedPorts.entrySet())
          {
      ...
      if (struct.isSetAssignedPorts()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter121 : struct.assignedPorts.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.assignedPorts = new HashMap<String,Integer>(2*_map122.size);
          String _key123;
          int _val124;
          for (int _i125 = 0; _i125 < _map122.size; ++_i125)
          {
            ...
            struct.assignedPorts.put(_key123, _val124);
          }
        }
        struct.setAssignedPortsIsSet(true);
      }
