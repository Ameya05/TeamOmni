            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.settings = new HashMap<String,String>(2*_map382.size);
                String _key383;
                String _val384;
                for (int _i385 = 0; _i385 < _map382.size; ++_i385)
                {
                  ...
                  struct.settings.put(_key383, _val384);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TierConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.settings != null) {
        oprot.writeFieldBegin(SETTINGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter386 : struct.settings.entrySet())
          {
      ...
      if (struct.isSetSettings()) {
        {
          ...
          for (Map.Entry<String, String> _iter387 : struct.settings.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.settings = new HashMap<String,String>(2*_map388.size);
          String _key389;
          String _val390;
          for (int _i391 = 0; _i391 < _map388.size; ++_i391)
          {
            ...
            struct.settings.put(_key389, _val390);
          }
        }
        struct.setSettingsIsSet(true);
      }
