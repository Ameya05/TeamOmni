            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.backups = new HashSet<String>(2*_set262.size);
                String _elem263;
                for (int _i264 = 0; _i264 < _set262.size; ++_i264)
                {
                  _elem263 = iprot.readString();
                  struct.backups.add(_elem263);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListBackupsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.backups != null) {
        oprot.writeFieldBegin(BACKUPS_FIELD_DESC);
        {
          ...
          for (String _iter265 : struct.backups)
          {
      ...
      if (struct.isSetBackups()) {
        {
          ...
          for (String _iter266 : struct.backups)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.backups = new HashSet<String>(2*_set267.size);
          String _elem268;
          for (int _i269 = 0; _i269 < _set267.size; ++_i269)
          {
            _elem268 = iprot.readString();
            struct.backups.add(_elem268);
          }
        }
        struct.setBackupsIsSet(true);
      }
