            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.updateOnlyTheseInstances = new HashSet<Range>(2*_set198.size);
                Range _elem199;
                for (int _i200 = 0; _i200 < _set198.size; ++_i200)
                {
                  _elem199 = new Range();
                  _elem199.read(iprot);
                  struct.updateOnlyTheseInstances.add(_elem199);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobUpdateSettings struct) throws org.apache.thrift.TException {
      ...
      if (struct.updateOnlyTheseInstances != null) {
        oprot.writeFieldBegin(UPDATE_ONLY_THESE_INSTANCES_FIELD_DESC);
        {
          ...
          for (Range _iter201 : struct.updateOnlyTheseInstances)
          {
      ...
      if (struct.isSetUpdateOnlyTheseInstances()) {
        {
          ...
          for (Range _iter202 : struct.updateOnlyTheseInstances)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.updateOnlyTheseInstances = new HashSet<Range>(2*_set203.size);
          Range _elem204;
          for (int _i205 = 0; _i205 < _set203.size; ++_i205)
          {
            _elem204 = new Range();
            _elem204.read(iprot);
            struct.updateOnlyTheseInstances.add(_elem204);
          }
        }
        struct.setUpdateOnlyTheseInstancesIsSet(true);
      }
