            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.groups = new HashSet<ConfigGroup>(2*_set108.size);
                ConfigGroup _elem109;
                for (int _i110 = 0; _i110 < _set108.size; ++_i110)
                {
                  _elem109 = new ConfigGroup();
                  _elem109.read(iprot);
                  struct.groups.add(_elem109);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ConfigSummary struct) throws org.apache.thrift.TException {
      ...
      if (struct.groups != null) {
        oprot.writeFieldBegin(GROUPS_FIELD_DESC);
        {
          ...
          for (ConfigGroup _iter111 : struct.groups)
          {
      ...
      if (struct.isSetGroups()) {
        {
          ...
          for (ConfigGroup _iter112 : struct.groups)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.groups = new HashSet<ConfigGroup>(2*_set113.size);
          ConfigGroup _elem114;
          for (int _i115 = 0; _i115 < _set113.size; ++_i115)
          {
            _elem114 = new ConfigGroup();
            _elem114.read(iprot);
