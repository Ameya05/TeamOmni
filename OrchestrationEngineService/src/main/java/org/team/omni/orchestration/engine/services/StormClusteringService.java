...
public class StormClusteringService extends Service {
	...
	public StormClusteringService(WebTarget serviceAddress, OrchestrationEngineValueStore orchestrationEngineValueStore,ServiceInstance<InstanceDetails> serviceInstance,WorkFlowState workFlowState) {
		super(serviceAddress.path("/storm/clustering"), orchestrationEngineValueStore,serviceInstance,workFlowState);
	}
