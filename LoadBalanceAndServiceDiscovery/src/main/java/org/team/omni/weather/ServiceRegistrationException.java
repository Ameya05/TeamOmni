...
public class ServiceRegistrationException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4945770043583776439L;
	...
	public ServiceRegistrationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
